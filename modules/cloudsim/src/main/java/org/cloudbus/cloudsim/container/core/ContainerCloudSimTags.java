...
public class ContainerCloudSimTags {
     ...
     */
    public static final int USER_REQUEST_SUBMIT = ContainerSimBASE + 7;
    /**
     * Denotes the user req is finished.
     * Invoked internally in the Task scheduler
     */
    public static final int USER_REQUEST_RETURN = ContainerSimBASE + 8;

    /**
     * Denotes the task assigned to the data center.
     * Invoked in broker
     */
    public static final int TASK_SUBMIT = ContainerSimBASE + 9;
    /**
     * Denotes the user req is finished.
     * Invoked in Broker
     */
    public static final int TASK_RETURN = ContainerSimBASE + 10;
    /**
     * Denotes the  host failure via injection.
     * Invoked in the Task scheduler
     */
    public static final int HOST_FAIL = ContainerSimBASE + 11;
    /**
     * Denotes the  host deallocated from DC.
     */
    public static final int HOST_DESTROY = ContainerSimBASE + 12;
    /**
     * Denotes the  host recovery from failure.
     * Invoked in the Injection
     */
    public static final int HOST_RECOVER = ContainerSimBASE + 13;
    /**
     * Denotes the  host recovered from failure.
     * Invoked in the data centar
     */
    public static final int HOST_RECOVER_ACK = ContainerSimBASE + 14;
    /**
     * Denotes the DC info is logged to console.
     * Invoked in the dc
     */
    public static final int CONTAINER_DC_LOG = ContainerSimBASE + 15;
    /**
     * Denotes the containers are deallocated in the data center.
     * Invoked in the dc
     */
